...
public class UserController {
    ...
    @GetMapping("/{id}/favourite-countries")
    public ResponseEntity<List<CountryDto>> getFavoriteCountriesByUserId(@PathVariable Long id) {
        return ResponseEntity.ok(userService.getFavoriteCountriesByUserId(id));
    }
}
